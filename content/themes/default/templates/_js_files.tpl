...
{if $user->_logged_in && $system['onesignal_notification_enabled']}
    ...
    <script>
        var onesignal_basepath = "{$system['BASEPATH']}";
        ...
        OneSignal.push(function() {
            ...
            OneSignal.SERVICE_WORKER_PARAM = { scope: '/' + onesignal_basepath + '/' };
            OneSignal.SERVICE_WORKER_PATH = onesignal_basepath + '/OneSignalSDKWorker.js';
            OneSignal.SERVICE_WORKER_UPDATER_PATH = onesignal_basepath + '/OneSignalSDKUpdaterWorker.js';

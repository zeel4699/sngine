                            ...
                            <div class="card bg-gradient-warning">
                                <div class="card-body with-form">
                                    <div class="text-center mb10">
                                        ...
                                        <strong>{__("Invite Your Friends")}</strong>
                                    </div>
                        ...
                        {if $new_people || $new_pages || $new_groups || $new_events}
                            <div class="mini-footer mtb20 plr10">
                                <div class="copyrights">
                                    &copy; {'Y'|date} {$system['system_title']} <span class="text-link" data-toggle="modal" data-url="#translator"><i class="fas fa-globe-americas mr5"></i>{$system['language']['title']}</span>
                                </div>
                                <ul class="links">
                                    {if $static_pages}

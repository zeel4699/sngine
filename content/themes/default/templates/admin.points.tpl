    ...
    <div class="card-header with-icon">
        {if $sub_view == ""}
            <div class="float-right">
                <button type="button" class="btn btn-sm btn-danger js_admin-deleter" data-handle="user_points_reset">
                    <i class="fa fa-trash-alt"></i><span class="ml5 d-none d-lg-inline-block">{__("Clear All Users Points")}</span>
                </button>
            </div>
        {/if}
